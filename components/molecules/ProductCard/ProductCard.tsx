...
export default function ProductCard({ variant }: ProductCardProps) {
  if (variant === "Full Cover on Hover") {
    return (
      <div className="group relative h-[31.25rem] min-w-[26.875rem] max-w-xs cursor-pointer overflow-hidden rounded-2xl bg-gray-200 transition-all hover:bg-gray-300">
  ...
  return (
    <div className="group relative h-[31.25rem] min-w-[26.875rem] max-w-xs cursor-pointer overflow-hidden rounded-2xl bg-gray-200">
